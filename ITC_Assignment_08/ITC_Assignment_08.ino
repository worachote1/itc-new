...
void vSenderTask(void *pvParameters)
{
  ...
  const TickType_t xTicksToWait = pdMS_TO_TICKS(100);//100
...
void vReceiverTask(void *pvParameters)
{
  ...
  while (1)
  {
    qStatus = xQueueReceive(BlinkQueue, &valueReceived, xTicksToWait);  //Receive an item from a queue
                                                                        //xTicksToWait : The maximum amount of time the task should block waiting for an item to receive 
